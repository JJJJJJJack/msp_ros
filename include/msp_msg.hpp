...
struct WayPoint : public Message {
    ...
    virtual bool decode(const ByteVector& data) override {
        bool rc = true;
        rc &= data.unpack<int32_t>(msg1,100);
        rc &= data.unpack<int32_t>(msg2,100);
        rc &= data.unpack<int32_t>(msg3,100);
        rc &= data.unpack<int32_t>(msg4,100);
        rc &= data.unpack<int32_t>(msg5,100);
        rc &= data.unpack<int32_t>(msg6,100);
        rc &= data.unpack<int32_t>(msg7,100);
        return rc;
    }
};
